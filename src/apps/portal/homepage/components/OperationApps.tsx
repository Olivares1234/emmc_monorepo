...
import { operationsAccessApps } from "../datasets";

import AppTile from "./AppTile";

function OperationApps() {
  ...
  return (
    <div className="w-full mt-4">
      <h4 className="text-gray-500 font-normal text-2xl">Operations</h4>
      <div className="grid grid-cols-4 gap-x-4 gap-y-8">
        {operationsAccessApps.map((app) => (
          <AppTile
            key={app.label}
