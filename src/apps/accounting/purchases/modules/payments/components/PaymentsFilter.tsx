...
import { paymentsFilterDefault } from "apps/accounting/purchases/redux/constants";
import { selectPaymentsFilter } from "apps/accounting/purchases/redux/selectors";
...
function PaymentsFilter({ onChange, onClose }: AdvanceFilterModalProps) {
  const currentFilter = useAppSelector(selectPaymentsFilter);
  ...
  const handleReset = useCallback(() => {
    setFilter(paymentsFilterDefault);
  }, []);
