...
import { invoiceFilterDefault } from "apps/accounting/sales/redux/constants";
import { selectInvoiceFilter } from "apps/accounting/sales/redux/selectors";
...
import { currencyOpt, filterStatusOptions, sortOptions } from "./constants";

function InvoiceFilter({ onChange, onClose }: AdvanceFilterModalProps) {
  const currentFilter = useAppSelector(selectInvoiceFilter);
  ...
  const handleReset = useCallback(() => {
    setFilter(invoiceFilterDefault);
  }, []);

  const [customerOpt] = useGetCustomerOptions();
